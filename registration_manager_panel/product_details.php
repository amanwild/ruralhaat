  ...
  <div id="main_wrapper " style="padding:10px">
    ...
    <div id="dashboard">
      ...
      <div class="row text-center">
        <div style="padding:px;" class="col-lg-3 col-md-6">
          <div style="padding:5px;box-shadow: 0 7px 15px 0 rgba(0,0,0,0.15);background-color:#4f17ed ;color:white;"><a href="#">
              <div class="utf_dashboard_stat color-1">
                <div class="utf_dashboard_stat_content">
                  <h4 style="color:white;"><?= $default_listing_count ?></h4>
                  <span style="font-size: 14px; margin-top: 5px; line-height: 22px; font-weight: 400; color:white; opacity: 0.95; display: inline-block;">Total Listings</span>
                </div>
        ...
        <div style="padding:px;" class="col-lg-3 col-md-6">
          <div style="padding:5px;box-shadow: 0 7px 15px 0 rgba(0,0,0,0.15);background-color:green ;color:white;"><a href="#">
              <div class="utf_dashboard_stat color-1">
                <div class="utf_dashboard_stat_content">
                  <h4 style="color:white;"><?= $active_listing_count ?></h4>
                  <span style="font-size: 14px; margin-top: 5px; line-height: 22px; font-weight: 400; color:white; opacity: 0.95; display: inline-block;">Total Approved Listings</span>
                </div>
                <div class="utf_dashboard_stat_icon">
                  <i class="im im-icon-Map2"></i>
                </div>
          ...
          <div style="padding:5px;box-shadow: 0 7px 15px 0 rgba(0,0,0,0.15);background-color: #f1c40f ;color:white;">
            <a href="#">
              <div class="utf_dashboard_stat color-2">
                <div class="utf_dashboard_stat_content">
                  <h4 style="color:white;"><?= $pending_listing_count ?></h4>
                  <span style="font-size: 14px; margin-top: 5px; line-height: 22px; font-weight: 400; color:white; opacity: 0.95; display: inline-block;">Total Pending Listings</span>
                </div>
                <div class="utf_dashboard_stat_icon">
          ...
          <div style="padding:5px;box-shadow: 0 7px 15px 0 rgba(0,0,0,0.15);background-color:#ff2222;color:white;">
            <a href="#">
              <div class="utf_dashboard_stat color-3">
                <div class="utf_dashboard_stat_content">
                  <h4 style="color:white;"><?= $expired_listing_count ?></h4>
                  <span style="font-size: 14px; margin-top: 5px; line-height: 22px; font-weight: 400; color:white; opacity: 0.95; display: inline-block;">Total Rejected Listings</span>
                </div>
                <div class="utf_dashboard_stat_icon">
