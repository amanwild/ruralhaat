...
// // echo $user;
// // // echo "<br>";
if ((isset($_SESSION['user_username']) && ( (($_SESSION['user_type']=='admin')||($_SESSION['user_type']=='user' || $_SESSION['user_type']=='inspector')) && ($_SESSION['is_verified_admin'] == '1')))|| ($_SESSION['user_type']=='buyer')) {
