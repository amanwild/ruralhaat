	...
	<section class="classiera-navbar   classiera-navbar-v6 ">
		...
		<nav id="myNavmenu" class="navmenu navmenu-default offcanvas offcanvas-light navmenu-fixed-left" role="navigation">
			...
			<div class="log-reg-btn text-center">
				...
				<a href="./logout/index.php" class="offcanvas-log-reg-btn"><i class="fas fa-user"></i>
					Logout </a>
			...
			<div class="menu-main-menu-container">
				<ul id="menu-main-menu" class="nav navmenu-nav">
					...
					<li id="menu-item-192" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-192"><a title="Categories" href="./admin_panel/index.php">Admin Panel</a></li>
			...
			<nav class="navbar navbar-default ">
				...
				<div class="collapse navbar-collapse visible-lg" id="navbarCollapse">
					<div class="navbar-right login-reg flip">
						<a href="./logout/index.php" class="btn btn-primary outline round">Logout</a>
					</div>
					<ul id="menu-main-menu-1" class="nav navbar-nav navbar-right nav-margin-top flip nav-ltr">
						...
						<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-191"><a title="Login V2" href="./admin_panel/index.php">Admin Panel</a></li>
