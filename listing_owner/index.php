                ...
                <div class="author-social">
                  ...
                  <div class="author-social-icons">
                    <ul class="list-unstyled list-inline">
                      ...
                      ?>
                        <form method="POST" id="facebook_interaction" style="display:inline-block;cursor:pointer;">
                      ...
                      ?>
                        <form method="POST" id="google_interaction" style="display:inline-block;cursor:pointer;">
                      ...
                      ?>
                        <form method="POST" action="<?= $listing_owner_youtube_link ?>" id="youtube_interaction" style="display:inline-block;cursor:pointer;">
                      ...
                      ?>
                        <form method="POST" action="mailto:<?= $listing_owner_email ?>" id="email_interaction" style="display:inline-block;cursor:pointer;">
                  ...
                  <div class="contact-detail-row">
                    <div class="contact-detail-col">
                      <span>
                        ...
                        ?>
                         <form method="POST" action="tel:<?= $listing_owner_phone ?>" id="tel_interaction" style="display:inline-block;cursor:pointer;">
                    ...
                    ?>
                      ...
                      <form method="POST" action="mailto:<?= $listing_owner_email ?>" id="email_interaction2" style="display:inline-block;cursor:pointer;">
                          <button class="btn" name="email_interaction" value="true" type="submit">
                          <span>
                          <i class="fas fa-envelope"></i>
