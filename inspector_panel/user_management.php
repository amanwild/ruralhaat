    ...
    <div class="table-responsive" style="border:3px solid grey;padding:5px;">
      <table data-role="table" class="table ui-responsive datatable  " id="myTable">
        ...
        <tbody>
          ...
          $select_user_query = "SELECT * FROM `users_entries` WHERE is_verified_email = 1 and user_type not like 'admin' ORDER BY `users_entries`.`user_timestamp` DESC";
          // echo$fname,$lname;
          try {
          ...
          ?>
              <tr id="row_<?= $row['user_id'] ?>" class="row_by_id" style="">
                ...
                <td class="text-center">
                  <a href="../user_management_panel/dashboard.php?slave_id=<?= $row['user_id'] ?>" type="button" style="cursor: pointer;width:50px;margin-right:0px;font-size:25px !important;" id="approve_<?= $row["loc_id"] ?>" class="d-inline edit table_edit_btn"> 👁️‍🗨️</a>
                </td>
              </tr>
          <?php
            }
