  ...
  <body data-rsssl=1 class="page-template page-template-template-contact page-template-template-contact-php page page-id-33 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
   <?php include "../navbar/index.php";?>
    <section class="inner-page-content ">
      ...
      <img style="width:100%;" id="image" src="../wp-content/uploads/2018/11/Har-Ghar-Tiranga_banner.jpg" "alt="  ">
    </section>

    <section class="inner-page-content border-bottom ">
      <div class="login-register" style="padding-top:0px;">
        <div class="container">
          <div class="row">
            ...
            <div class="classiera-login-register-heading border-bottom text-center">
              <h3 class="text-uppercase">Send Request For Registration Using Google Account</h3>
            </div>
