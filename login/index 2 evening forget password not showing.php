...
<head>
  ...
  <title>Send Request &#8211; Ruralhaat</title>
...
*/
  ...
  <link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embedf71c.json?url=https%3A%2F%2Fdemo.joinwebs.com%2Fclassiera%2Fplum%2Fcontact%2F" />
  <link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embedbc8f?url=https%3A%2F%2Fdemo.joinwebs.com%2Fclassiera%2Fplum%2Fcontact%2F&amp;format=xml" />
...
<body data-rsssl=1 class="page-template page-template-template-contact page-template-template-contact-php page page-id-33 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
        ...
        <div class="menu-main-menu-container">
          <ul id="menu-main-menu" class="nav navmenu-nav">
            <li id="menu-item-190" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children menu-item-190 dropdown">
              <a title="Home" href="../index.html" data-toggle="dropdown" data-hover="dropdown" data-animations="fadeIn" class="dropdown-toggle" aria-haspopup="true">Home <span class="caret"></span></a>

            </li>


            <li id="menu-item-191" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-191"><a title="Blog" href="#">Blog</a></li>
        ...
        <nav class="navbar navbar-default ">
          ...
          <div class="collapse navbar-collapse visible-lg" id="navbarCollapse">
            ...
            <ul id="menu-main-menu-1" class="nav navbar-nav navbar-right nav-margin-top flip nav-ltr">
              ...
              <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-192"><a title="Sucess Stories" href="#">Sucess Stories </a></li>

              <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-191"><a title="Blog" href="#">Blog</a></li>
              <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-33 current_page_item menu-item-193 active">
                <a title="Contact" href="../contact/index.php">Contact</a>
              </li>
            </ul>
                ...
                <div class='apsl-login-networks theme-1 clearfix'>
                  <div class='social-networks'>
                    <div class="form-group text-center">
                      <p>
                        <a href="<?php echo $google_client->createAuthUrl(); ?>" style="margin:10px;text-decoration:none !important;background-color:#3b5998;color:white;font-weight:900;font-size:25px;padding:15px !important;padding-right:25px !important;padding-left:25px !important;border-radius:100px;">F</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-sm-6">
          <p>
            All copyrights reserved © 2015 - Design & Development by <a href="#">Royals Webtech Pvt. Ltd.</a> </p>
        </div>
        <div class="col-lg-6 col-sm-6">
  ...
  <script type='text/javascript' id='classiera-helper-js-extra'>
    ...
    var classiera = {
      ...
      "current_user": "0",
      "redirectURL": "https:\/\/demo.joinwebs.com\/classiera\/plum\/contact\/"
    };
    /* ]]> */
  </script>
...
if ($login_button == '') {
  ...
  // // echo '<h3><b>Phone :</b> ' . $_SESSION['user_phone_no'] . '</h3>';
  // echo '<h3><a href="logout.php">Logout</h3></div>';
  // echo '<h3><a href="deno.php">demo</h3></div>';
              ...
              <div class="col-lg-12" id="register_form">
                ...
                <form id="registration_form" class="text-center">
                  ...
                  <div class="form-group text-left">
                    <div class="inner-addon left-addon ">
                      <i class="left-addon form-icon fas fa-user"></i>
                      <input type="button" value="<?php echo $_SESSION['user_username']; ?>" name="register_username" id="register_username" class="form-control form-control-md sharp-edge" placeholder="Enter username" data-error="Username required" required>
                      <div class="help-block with-errors"></div>
                    </div>
                  </div><!--username-->
                  <div class="form-group">
                    <div class="inner-addon left-addon">
                      ...
                      <input type="button" value="<?php echo $_SESSION['user_first_name']; ?>" name="register_first_name" id="register_first_name" class="form-control form-control-md sharp-edge" placeholder="Enter First name" data-error="First name required" required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="form-group">
                    <div class="inner-addon left-addon">
                      ...
                      <input type="button" value="<?php echo $_SESSION['user_last_name']; ?>" name="register_last_name" id="register_last_name" class="form-control form-control-md sharp-edge" placeholder="Enter Last name" data-error="Last name required" required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="form-group">
                    <div class="inner-addon left-addon">
                      ...
                      <input type="button" value="<?php echo $_SESSION['user_email']; ?>" name="register_email" id="register_email" class="form-control form-control-md sharp-edge" placeholder="Enter email address" data-error="Email required" required>
                      <div class="help-block with-errors"></div>
                    </div>
                  </div><!--Email Address-->
                  ...
                  <div class="form-group">
                    ...
                    <button class="btn btn-primary sharp btn-md btn-style-one" id="edit-submit" name="op_classiera" type="submit">Send Request</button>
                  </div><!--register button-->
                </form>
              </div>
              <!--Register-->
...
<?php
  ...
  // echo '<div align="center">' . $login_button . ' login button</div>';
}
