...
if (true) {
    $email_verification_msg = "Your account status is Pending. Your Account will be activate within 24 hours.";
    $unsubscribe_msg = "";
} 
?>
                        ...
                        <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
                            <tr>
                                <td bgcolor='#ffffff' align='center' valign='top' style='padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: ' Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;'>
                                    <h2 style='font-size: 40px; font-weight: 400; margin: 2; line-height: 48px;'><?= $email_verification_msg ?></h2> <img src=' https://img.icons8.com/clouds/100/000000/handshake.png' width='125' height='120' style='display: block; border: 0px;' />
                                </td>
                            </tr>
                        </table>
                    </td>
