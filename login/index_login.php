                  ...
                  <div class='apsl-login-networks theme-1 clearfix'>
                    ...
                    <div class="form-group text-center">
                      <p>
                        ...
                        <a href="../login-v2/index.php" style="margin:10px;text-decoration:none !important;background-color:#dc4e41;color:white;font-weight:900;font-size:25px;padding:15px !important;border-radius:100px;">G+</a>
                      </p>
                    </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-9 col-lg-9 col-xs-12 pull-right flip">
                    <div class="form-group clearfix">
                      <p class="forget-pass pull-right flip">
                        <a onclick="Show_forget_pass()" style="padding:5px;">Forgot Password?</a>
                      </p>
                    </div>
                    <!--Google-->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-sm-6">
          <p>
            All copyrights reserved © 2015 - Design & Development by <a href="#">RoyalsWebTech</a> </p>
        </div>
        <div class="col-lg-6 col-sm-6">
