...
<body data-rsssl=1 class="page-template page-template-template-login page-template-template-login-php page page-id-49 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
    ...
    <div class="container">
        ...
        if (($_SERVER["REQUEST_METHOD"] == "POST") && isset($_POST['addProduct'])) {
            ...
            $product_brand = filter($_POST["product_brand"]);
            $product_category = filter($_POST["product_category"]);
            $product_price = filter($_POST["product_price"]);
            $product_image = filter($_POST["product_image"]);

            $add_product_query = "INSERT INTO `product` ( `product_name`, `product_price`, `product_image`, `product_brand`, `product_category`) VALUES ( '$product_name', '$product_price', '$product_image', '$product_brand', '$product_category')";

            try {
                $add_product_result = mysqli_query($connect, $add_product_query);
                ...
                <div class=" mb-4">
                    <div class="card-body " style="margin-top:20px !important; border-radius:8px ;box-shadow: 1px 1px 20px #000000;">
                        <div class="jumbotron py-1" style="border-radius:8px;background-color: gold linear-gradient(to bottom, lightyellow, gold);">
                            <div class=" my-4 ">
                                <h1 class=" my-auto mr-auto d-inline"> Add Product <p class="d-inline text-center align-middle" style="color:green;font-size:20px;"></p>
                                </h1>
                                <hr class="my-3">
                                <form enctype="multipart/form-data"  class="needs-validation " action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" novalidate>
                                    <div class="container p-2 " style="border-radius:8px;">

                                        <input type="hidden" class="addProduct" id="addProduct" name="addProduct">
                                        <script>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-5 mx-auto mb-3">
                                                <label for="product_name">Name </label><span style="color:red;"> *</span>
                                                <input type="text" class="form-control " id="product_name" name="product_name" placeholder="Product Name" required>


                                            </div>
                                            <div class="col-md-5 mx-auto mb-3">
                                                <label for="product_brand">Brand</label><span style="color:red;"> *</span>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-5 mx-auto mb-3">
                                                <label for="product_price">Price</label><span style="color:red;"> *</span>
                                                <input type="number" class="form-control" id="product_price" name="product_price" placeholder="" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-5 mx-auto mb-3">
                                                <label for="product_image">Image </label><span style="color:red;"> *</span>
                                                <input type="file" class="form-control " id="product_image" name="product_image" placeholder="" required>
                            ...
                            <div class="modal-footer text-center">
                                <button type="button" class="table_btn btn btn-secondary " onclick="window.location.href='./index.php'">Go Back</button>
                                <button type="submit" class="btn btn-success mx-auto" style="padding:10px !important;">Save</button>
                            </div>
                            </form>
                        </div>
                    </div>
