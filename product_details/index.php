...
<body data-rsssl=1 class="page-template page-template-template-login page-template-template-login-php page page-id-49 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
    ...
    <section class="classiera-navbar   classiera-navbar-v6 ">
      ...
      <nav id="myNavmenu" class="navmenu navmenu-default offcanvas offcanvas-light navmenu-fixed-left" role="navigation">
        <div class="navmenu-brand clearfix">
          <a href="../index.html">
            <img src="../wp-content/uploads/2021/12/plum-logo.png" alt="Classiera Classifieds Ads WordPress Theme">
          </a>
          ...
          <div class="collapse navbar-collapse visible-lg" id="navbarCollapse">
            ...
            <div class="navbar-right login-reg flip">
              ...
              <form id="myForm"action="../logout/index.php" method="POST">
                ...
                <a class="btn btn-primary outline round" onclick="myFunction()" type="submit" id="logout_btn" name="logout_btn">Logout</a>
              ...
              <!-- <li
                ...
                <ul role="menu" class="dropdown-menu">
                  ...
                  <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-198"><a title="Login V2"
                      href="../login-v2/index.html">Login V2</a></li>
  ...
  <div class="container">
    ...
    $select_query = "SELECT * FROM `product`"; //NOTE: here (`) is not equal to (')
    try {
      $select_result = 0;
      if ($connect) {
    ...
    <div id="main" class="">
      <div class="allContent-section container   pt-0" style="margin-bottom: 20px;">
        <div id="edit_loc" style="display :none;">

          <h5 class=" my-auto mr-auto d-inline " style="font-weight: 700;"> Edit product <span type="button" style="width:50px;margin-right:0px;" id="' . $row['Id'] . '" class="d-inline edit table_edit_btn" data-bs-toggle="modal" data-bs-target="#editModal"> 📝</span>
          </h5>
          ...
          <div class="table-responsive mt-3">
            <table class="d">
              <tr class="table_head">
                ...
                <th class="table_label" scope="col">Brand</th>
                <th class="table_label" scope="col">Category</th>
                <th class="table_label" scope="col">Price</th>
                <th class="table_label" scope="col">Image</th>
                <th class="table_label" scope="col">Action</th>
              </tr>
              <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                <tr class="table_data">
                  <input type="hidden" name="snoEdit" id="snoEdit">
                  <td>
                    <div class="d-flex p-1 table_input"><input type="text" name="nameEdit" id="nameEdit" required></div>
                  </td>
                  <td>
                    <div class="d-flex p-1 table_input"><input type="text" name="brandEdit" id="brandEdit" required></div>
                  </td>
                  <td>
                    <div class="d-flex p-1 table_input"><input type="text" name="categoryEdit" id="categoryEdit" required></div>
                  </td>
                  <td>
                    <div class="d-flex p-1 table_input"><input type="text" name="priceEdit" id="priceEdit" required></div>
                  </td>
                  <td>
                    <div class="d-flex p-1 table_input"><input type="file" name="imageEdit" id="imageEdit" required></div>
                  </td>

                  <td>
                    <div class="d-flex p-1 table_botton" style="width:100%;">
                      <div class="mx-1">
                        <button type="button" onclick="done_edit_loc()" class="table_btn btn btn-outline-secondary " onclick="window.location.href='./viewProduct.php'">Close</button>
                      </div>
                      <div class="mx-1">

                        <button type="submit" id="" class="table_save_btn  btn btn-primary "> Save </button>
                      </div>
                    </div>
                  </td>
                </tr>
        ...
        <div class=" my-1">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td><img src="../wp-content/uploads/data/<?= $row['product_image'] ?>" class="rounded-circle img-fluid" style="width: 50px;object-fit:cover;height:50px" class="mr-3 p-1" alt="." /></td>
                      <td><?= $row['product_since'] ?></td>
                      <td class="text-center">
                        <span type="button" style="width:50px;margin-right:0px;" id="<?= $row['product_id'] ?>" class="d-inline edit table_edit_btn" data-bs-toggle="modal" onclick="edit_loc()" data-bs-target="#editModal"> 📝</span>
                        <span style="width:50px;margin-right:0px;" id="d<?= $row['product_id'] ?>" type="button" id="d' . $row['Id'] . '" class="d-inline delete table_delete_btn "> ❌</span>
                      </td>
                    </tr>
                <?php
                  }
          ...
          <div class="" style="display:flex;text-align:center; ">
            <button type="button" style="padding:10px !important;" class="table_btn btn btn-success " onclick="window.location.href='./addproduct_details.php'">Add Products
            </button>
          </div>
        </div>
                          ...
                          <figure class="clearfix">
                            <a href="../used-bmw-car-2018-model-for-sale/index.html">
                              <div class="premium-img">
                                ...
                                <span class="price"> Price : &dollar;&nbsp;5000 </span>
                                <span class="classiera-buy-sel"> For Sale </span>
                              </div>
                              <!--premium-img-->
                            </a>
                            ...
                            <figcaption>
                              ...
                              <div class="category">
                                ...
                                <span
                                  >Location :
                                  <a href="../index78a6.html?s=&amp;post_city=Richmond"
                                    >Richmond</a
                                  >
                                </span>
                              </div>
                              <p class="description">
                                ...
                                Phasellus accumsan, augue vel sodales pharetra, risus
                                elit vehicula lacus, sed iaculis ante neque vitae nisl.
                                Mauris interdum vitae quam quis ornare. Curabitur sed
    ...
    <script>
      // location_id = document.getElementById("location_1").innerHTML;
      ...
      Array.from(edits).forEach((element) => {
        element.addEventListener("click", (e) => {
          ...
          latitude = tr.getElementsByTagName("td")[3].innerText;
          longitude = tr.getElementsByTagName("td")[4].innerText;
          pincode = tr.getElementsByTagName("td")[5].innerText;
          // timezone = tr.getElementsByTagName("td")[6].innerText;

          snoEdit.value = e.target.id;
          nameEdit.value = country;
          brandEdit.value = city;
          categoryEdit.value = latitude;
          priceEdit.value = longitude;
          imageEdit.value = pincode;
          timezoneEdit.value = timezone;
          // console.log(country + sno);
        })
      })
      ...
      function edit_loc() {
        var x = document.getElementById("edit_loc");
        if (x.style.display === "none") {
          x.style.display = "block";
        }
      }

      function done_edit_loc() {
        var x = document.getElementById("edit_loc");
        if (x.style.display === "block") {
          x.style.display = "none";
        }

        country = nameEdit.value;
        city = brandEdit.value;
        latitude = categoryEdit.value;
        longitude = priceEdit.value;
        pincode = imageEdit.value;
        timezone = timezoneEdit.value;

        console.log(country + city);

        $.ajax({
          url: "http://localhost:8080/dashboard/update_table.php",
          type: "POST",
          data: {
            type: "like",
