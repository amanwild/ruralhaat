...
*/
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Quicksand:700,400,500&amp;display=swap&amp;ver=1651390143" media="print" onload="this.media='all'" />
  <noscript>
  ...
  <link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embedf65f.json?url=https%3A%2F%2Fdemo.joinwebs.com%2Fclassiera%2Fplum%2Flocations%2F" />
  <link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed8727?url=https%3A%2F%2Fdemo.joinwebs.com%2Fclassiera%2Fplum%2Flocations%2F&amp;format=xml" />
...
<body data-rsssl="1" class="page-template page-template-template-locations page-template-template-locations-php page page-id-45 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
  ...
  // $select_listing_query = "SELECT * FROM listing WHERE (listing_category_id LIKE '$listing_category_id')AND (listing_keyword LIKE '%$listing_keyword%' OR listing_title LIKE '%$listing_keyword%'OR listing_description LIKE '%$listing_keyword%') AND ( listing_city_id LIKE '%$listing_city%' OR  listing_state_id LIKE '%$listing_city%' OR listing_adderess LIKE '%$listing_city%') "; //NOTE: here (`) is not equal to (')
...
//NOTE: here (`) is not equal to (')

  // $select_listing_query = "SELECT *,COUNT(listing_rating_given),AVG(listing_rating_given) FROM listing left join category on listing.listing_category_id = category.category_id left join sub_category on listing.listing_sub_category_id = sub_category.id left join countries on listing.listing_country_id = countries.id left join states on listing.listing_state_id = states.id left join cities on listing.listing_city_id = cities.id left join users_entries on listing.listing_owner_id = users_entries.user_id left join listing_rating on listing.listing_id = listing_rating.listing_rating_on_product_id  group by listing.listing_id";
...
// echo $select_listing_query;
  ...
  <script type="text/javascript" id="classiera-helper-js-extra">
    ...
    var classiera = {
      ...
      current_user: "0",
      redirectURL: "https:\/\/demo.joinwebs.com\/classiera\/plum\/locations\/",
    };
    /* ]]> */
  </script>
