		...
		<figure class="clearfix">
			...
			<div class="detail text-center">
				...
				<div class="box-icon">
					...
					<a href="tel:<?= $listing_owner_phone ?>"><i class="fas fa-phone"></i></a>
				</div>
			...
			<figcaption>
				...
				<div class="category">
					<span>
						Category :
						<a href="search_ads/index.php?category_id=<?= $row['category_name'] ?>&listing_keyword=&listing_city=&search_listing=true" title="View all posts in Automotive"><?= $row['category_name'] ?></a> </span>
					<span>Location :
