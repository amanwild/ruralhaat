...
<head>
    ...
    <link rel="alternate" type="application/rss+xml" title="  » Feed" href="feed/index.html">
    <link rel="alternate" type="application/rss+xml" title="  » Comments Feed" href="comments/feed/index.html">
...
*/
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Quicksand:700,400,500&amp;display=swap&amp;ver=1651390143" media="all" onload="this.media='all'"><noscript>
    ...
    <link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embedfcfa.json?url=https%3A%2F%2Fdemo.joinwebs.com%2Fclassiera%2Fplum%2F">
    <link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embed9527?url=https%3A%2F%2Fdemo.joinwebs.com%2Fclassiera%2Fplum%2F&amp;format=xml">
...
<body data-rsssl="1" class="home page-template page-template-template-landing page-template-template-landing-php page page-id-43 theme-classiera woocommerce-js single-author elementor-default elementor-kit-1989">
    <!-- Preloader Start -->
    <!-- <div class="preloader">
        ...
        <section class="classiera-navbar   classiera-navbar-v6 ">
            ...
            <nav id="myNavmenu" class="navmenu navmenu-default offcanvas offcanvas-light navmenu-fixed-left" role="navigation">
                <div class="navmenu-brand clearfix">
                    <a href="../index.php">
                        <img src="./wp-content/uploads/2021/12/logo-grid-3 (2).png" alt="rural haat">
                    </a>
                ...
                <div class="log-reg-btn text-center">
                    <a href="login/index.php" class="offcanvas-log-reg-btn">
                        Login </a>
                    <a href="register/index.php" class="offcanvas-log-reg-btn">
                        Get Registered </a>
                </div>
                <div class="menu-main-menu-container">
                    <ul id="menu-main-menu" class="nav navmenu-nav">
                        <li id="menu-item-190" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children menu-item-190 dropdown">
                            <a title="Home" href="./index.php" class="" aria-haspopup="true">Home <span class="caret"></span></a>
                        </li>
                ...
                <div class="submit-post">
                    <a href="./user_panel/dashboard_add_listing.php" class="btn btn-block btn-primary btn-md active">
                        Submit Ad </a>
                </div><!--submit-post-->
                <div class="social-network " style="margin-bottom:100px;">
                ...
                <nav class="navbar navbar-default ">
                    ...
                    <div class="collapse navbar-collapse visible-lg" id="navbarCollapse">
                        ...
                        <ul id="menu-main-menu-1" class="nav navbar-nav navbar-right nav-margin-top flip nav-ltr">
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-43 current_page_item menu-item-has-children menu-item-190 dropdown active">
                                <a title="Home" href="index.php" data-toggle="dropdown" data-animations="fadeIn" class="dropdown-toggle" aria-haspopup="true">Home
                                    <!-- <span
										class="caret"></span> -->
                            ...
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-192"><a title="Sucess Stories" href="./success stories/index.php">Success Stories</a></li>

                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-191"><a title="Login V2" href="login-v2/index.php">Registration</a></li>
                            <!-- 					
    ...
    <section class="classiera-static-slider">
        ...
        <section class="search-section search-section-v6">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <form enctype="multipart/form-data" data-toggle="validator" role="search" class="search-form search-form-v2 form-inline" action="./search_ads/index.php" method="get" novalidate="true">
                            <div class="form-v6-bg">
                                <div class="form-group clearfix">
                                    <div class="inner-addon left-addon right-addon">
                                        ...
                                        <select class="form-control form-control-lg" data-placeholder="Select Category.." name="category_name" id="ajaxSelectCat">
                                            ...
                                            <option value="Kids Equipments"> Kids Equipments </option>
                                ...
                                <div class="form-group classieraAjaxInput">
                                    <div class="input-group inner-addon left-addon">
                                        ...
                                        <span class="classieraSearchLoader" style="display: none;"><img src="wp-content/themes/classiera/images/loader.gif" alt="classiera loader"></span>
                                        <div class="classieraAjaxResult" style="display: none;"></div>
                                    </div>
                                </div><!--form-group-->
                                <!--Searchlocation-->
    ...
    <img class="img-responsive" src="wp-content/uploads/2018/11/india.jpg" alt=" ">


    <div class="image-container">
        <img class="img-responsive" src="wp-content/uploads/2018/11/mgiri.png" alt=" ">
    </div>
    <br>
    ...
    <marquee class="sampleMarquee" direction="left" scrollamount="10" behavior="scroll">Today News</marquee>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="classiera-category-content">
                        <a href="./search_ads/index.php?category_id=1&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" class="classiera-category-new-v2-box" data-color="rgb(104,62,255)">
                            <span class="classiera-category-new-v2-box-img">
                                <img src="wp-content/uploads/data/veg.jpg" alt="vegetable">
                            </span>
                            <h5 class="classiera-category-new-v2-box-title">
                                Vegitable </h5>
                        </a>

                        <a href="./search_ads/index.php?category_id=2&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" class="classiera-category-new-v2-box" data-color="rgb(0,188,157)">
                            <span class="classiera-category-new-v2-box-img">
                                <img src="wp-content/uploads/data/grain.png" alt="vegetable">
                            </span>
                            <h5 class="classiera-category-new-v2-box-title">
                                Grains </h5>
                        </a>

                        <a href="./search_ads/index.php?category_id=21&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" class="classiera-category-new-v2-box" data-color="rgb(255,126,62)">
                            <span class="classiera-category-new-v2-box-img">
                                <img src="wp-content/uploads/data/animalH.jpg" alt="vegetable">
                            </span>
                            <h5 class="classiera-category-new-v2-box-title">
                                Animal Husbandry </h5>
                        </a>

                        <a href="./search_ads/index.php?category_id=23&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" class="classiera-category-new-v2-box" data-color="rgb(255,62,152)">
                            <span class="classiera-category-new-v2-box-img">
                                <img src="wp-content/uploads/data/1690372721fruit.png" alt="vegetable">
                            </span>
                            <h5 class="classiera-category-new-v2-box-title">
                                Fruit </h5>
                        </a>

                        <a href="./search_ads/index.php?category_id=39&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" class="classiera-category-new-v2-box" data-color="rgb(231,107,119)">
                            <span class="classiera-category-new-v2-box-img">
                                <img src="wp-content/uploads/data/1690372762Furniture-houseHold.png" alt="vegetable">
                            </span>
                            <h5 class="classiera-category-new-v2-box-title">
                                Furniture &amp; Household </h5>
                        </a>

                        <a href="./search_ads/index.php?category_id=71&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" class="classiera-category-new-v2-box" data-color="rgb(57,68,76)">
                            <span class="classiera-category-new-v2-box-img">
                                <img src="wp-content/uploads/data/1690372741Health-Fitness.png" alt="vegetable">
                            </span>
                            <h5 class="classiera-category-new-v2-box-title">
                                Health &amp; Fitness </h5>
                        </a>

                        <a href="./search_ads/index.php?category_id=74&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" class="classiera-category-new-v2-box" data-color="rgb(255,62,152)">
                            <span class="classiera-category-new-v2-box-img">
                                <img src="wp-content/uploads/data/1690372568jobs.png" alt="vegetable">
                            </span>
                            <h5 class="classiera-category-new-v2-box-title">
                                Jobs </h5>
                        </a>

                        <a href="./search_ads/index.php?category_id=76&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" class="classiera-category-new-v2-box" data-color="rgb(253,183,3)">
                            <span class="classiera-category-new-v2-box-img">
                                <img src="wp-content/uploads/data/1690372541Kids-Equipments.png" alt="vegetable">
                            </span>
                            <h5 class="classiera-category-new-v2-box-title">
                                Kids Equipments </h5>
                        </a>

                        <a href="./search_ads/index.php?category_id=125&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" class="classiera-category-new-v2-box" data-color="red">
                            <span class="classiera-category-new-v2-box-img">
                                <img src="wp-content/uploads/data/1690375999Pets-Animals.png" alt="vegetable">
                            </span>
                            <h5 class="classiera-category-new-v2-box-title">
                                Pet &amp; Animals </h5>
                        </a>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 center-block text-center">
                    ...
                    <marquee behavior="alternate">
                        <h1>WELCOME TO <span class="color">RURALHAAT</span></h1>
                    </marquee>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 center-block">
                        ...
                        <img style="margin:auto;" class="img-responsive " src="wp-content/uploads/2018/11/line_d-removebg-preview.png">
                        ...
                        <div style="margin-bottom: 40px;">
                            <div id="owl-demo" class="owl-carousel premium-carousel-v5 owl-theme owl-responsive-0 owl-loaded" data-car-length="4" data-items="4" data-loop="true" data-nav="false" data-autoplay="true" data-autoplay-timeout="3000" data-dots="false" data-auto-width="false" data-auto-height="true" data-right="false" data-responsive-small="1" data-autoplay-hover="true" data-responsive-medium="2" data-responsive-large="4" data-responsive-xlarge="4" data-margin="30">
                                ...
                                <div class="owl-stage-outer">
                                    <div class="owl-stage" style="transform: translate3d(-1561.6px, 0px, 0px); transition: all 0.25s ease 0s; width: 3904px;">
                                        <div class="owl-item cloned" style="width: 360.4px; margin-right: 30px;">
                                            <div class="classiera-box-div-v5 item match-height" style="">
                                                <figure>
                                                    <div class="premium-img">
                                                        <img class="img-responsive" src="wp-content/uploads/data/1pngtree-webcam-icon-in-cartoon-style-png-image_1772636.jpg" alt="">
                                                        <span class="hover-posts">
                                                            <a href="#"></a>
                                                        </span>
                                                    </div>
                                                    <figcaption>
                                                        <h5><a href="#">Shri Bhanu Pratap Singh</a>
                                                        </h5>
                                                        <div class="category">
                                                            <span>
                                                                <a href="#">
                                        ...
                                        <div class="owl-item cloned" style="width: 360.4px; margin-right: 30px;">
                                            <div class="classiera-box-div-v5 item match-height" style="">
                                                <figure>
                                                    <div class="premium-img">
                                                        <img class="img-responsive" src="wp-content/uploads/data/2pngtree-webcam-icon-in-cartoon-style-png-image_1772636.jpg" alt="">
                                                        <span class="hover-posts">
                                                            <a href="#"></a>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="owl-item" style="width: 360.4px; margin-right: 30px;">
                                            <div class="classiera-box-div-v5 item match-height" style="">
                                                <figure>
                                                    <div class="premium-img">
                                                        <img class="img-responsive" src="wp-content/uploads/data/happy-client-03.jpg" alt="">
                                                        <span class="hover-posts">
                                                            <a href="#"></a>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="owl-item" style="width: 360.4px; margin-right: 30px;">
                                            <div class="classiera-box-div-v5 item match-height" style="">
                                                <figure>
                                                    <div class="premium-img">
                                                        <img class="img-responsive" src="wp-content/uploads/data/happy-client-02.jpg" alt="">
                                                        <span class="hover-posts">
                                                            <a href="#"></a>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="owl-item active" style="width: 360.4px; margin-right: 30px;">
                                            <div class="classiera-box-div-v5 item match-height" style="">
                                                <figure>
                                                    <div class="premium-img">
                                                        <img class="img-responsive" src="wp-content/uploads/data/1png-transparent-international-general-knowledge-olympiad-igko-workbook-class-2-learning-school-class-knowledge-management-course-thumbnail.png" alt="">
                                                        <span class="hover-posts">
                                                            <a href="#"></a>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="owl-item" style="width: 360.4px; margin-right: 30px;">
                                            <div class="classiera-box-div-v5 item match-height" style="">
                                                <figure>
                                                    <div class="premium-img">
                                                        <img class="img-responsive" src="wp-content/uploads/data/user_avatar_09.jpg" alt="">
                                                        <span class="hover-posts">
                                                            <a href="#"></a>
                                                        </span>
                                                    </div>
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="all">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 match-height item item-grid-medium" style="height: 270px;">
                                <div class="classiera-box-div classiera-box-div-v5">
                                    <figure class="clearfix">
                                        <a href="./listing_details/index.php?listing_id=21">
                                            <div class="premium-img">
                                                ...
                                                <img class="img-responsive" src="wp-content/uploads/data/51bPQQFs2SL.jpg" alt="chana">
                                                <span class="hover-posts">
                                                    <span>View Ad</span>
                                                </span>
                                                <span class="price">
                                        ...
                                        <div class="detail text-center">
                                            ...
                                            <a href="./listing_details/index.php?listing_id=21" class="btn btn-primary outline btn-style-five">View Ad</a>
                                        </div>
                                        <figcaption>
                                            <span class="price visible-xs">
                                                Price :
                                                56 ₨ </span>
                                            <h5><a href="./listing_details/index.php?listing_id=21">chana</a>
                                            </h5>
                                            <div class="category">
                                                <span>
                                                    Category :
                                                    <a href="search_ads/index.php?category_id=Grains&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" title="Grains">Grains</a> </span>
                                                <span>Location :
                                                    <a href="index78a6.html?s=&amp;post_city=Richmond">bhandara</a>
                                                </span>
                                            </div>
                                            <h5>
                                                <span>
                                                    ...
                                                    <span class="stars21all">
                                                        <i style="margin-right: 0px;" class="fa-solid fa-star"></i>
                                                        <i style="margin-right: 0px;" class="fa-solid fa-star"></i>
                                                        <i style="margin-right: 0px;" class="fa-solid fa-star"></i>
                                                        <i style="margin-right: 0px;" class="fa-solid fa-star"></i>
                                                        <i style="margin-right: 0px;" class="fa-solid fa-star"></i>
                                                    </span>(<span style="margin-right: 0px;" id="rating_21all">0</span>)
                                                </span>
                                            </h5>
                                            <p class="description">chana with high protein </p>
                                        </figcaption>
                                    </figure>
                                </div><!--row-->
                            </div><!--col-lg-4-->
                            ...
                            <script>
                                ...
                                const stars21all = document.querySelectorAll(".stars21all i");

                                // Loop through the "stars" NodeList
                                stars21all.forEach((star, index1) => {
                                    // Add an event listener that runs a function when the "click" event is triggered
                                    // star.addEventListener("click", () => {
                                    // Loop through the "stars" NodeList Again
                                    stars21all.forEach((star, index2) => {
                                        // Add the "active" class to the clicked star and any stars with a lower index
                                        // and remove the "active" class from any stars with a higher index

                                        -1 >= index2 ? star.classList.add("active") : star.classList.remove("active");
                                        document.getElementById("rating_21all").innerHTML = 0;
                                        // console.log(index1);
                                    });
                                    // });
                                });
                            ...
                            <style>
                                ...
                                .stars47popular i.active {
                                    color: #ff9c1a !important;
                                }
                            </style>
                            <div class="col-lg-4 col-md-4 col-sm-6 match-height item item-grid-medium" style="height: 246.55px;">
                                <div class="classiera-box-div classiera-box-div-v5">
                                    <figure class="clearfix">
                                        <a href="./listing_details/index.php?listing_id=47">
                                            <div class="premium-img">
                                                <div class="featured-tag">
                                                    <span class="left-corner"></span>
                                                    <span class="right-corner"></span>
                                                ...
                                                <img class="img-responsive" src="wp-content/uploads/data/01-100x100.jpg" alt="sd">
                                                <span class="hover-posts">
                                                    <span>View Ad</span>
                                                </span>
                                                <span class="price">
                                        ...
                                        <div class="detail text-center">
                                            ...
                                            <a href="./listing_details/index.php?listing_id=47" class="btn btn-primary outline btn-style-five">View Ad</a>
                                        </div>
                                        <figcaption>
                                            <span class="price visible-xs">
                                                Price :
                                                785432 ₨ </span>
                                            <h5><a href="./listing_details/index.php?listing_id=47">sd</a>
                                            </h5>
                                            <div class="category">
                                                <span>
                                                    Category :
                                                    <a href="search_ads/index.php?category_id=Grains&amp;listing_keyword=&amp;listing_city=&amp;search_listing=true" title="Grains">Grains</a> </span>
                                                <span>Location :
                                                    <a href="index78a6.html?s=&amp;post_city=Richmond">Bharatwada Road Kalmana</a>
                                                </span>
                                            </div>
                                            <h5>
                                                <span>
                                                    ...
                                                    <span class="stars47popular">
                                                        <i style="margin-right: 0px;" class="fa-solid fa-star"></i>
                                                        <i style="margin-right: 0px;" class="fa-solid fa-star"></i>
                                                        <i style="margin-right: 0px;" class="fa-solid fa-star"></i>
                                                        <i style="margin-right: 0px;" class="fa-solid fa-star"></i>
                                                        <i style="margin-right: 0px;" class="fa-solid fa-star"></i>
                                                    </span>(<span style="margin-right: 0px;" id="rating_47popular">0</span>)
                                                </span>
                                            </h5>
                                            <p class="description">sasa </p>
                                        </figcaption>
                                    </figure>
                                </div><!--row-->
                            </div><!--col-lg-4-->
                            ...
                            <script>
                                // Select all elements with the "i" tag and store them in a NodeList called "stars"
                                const stars47popular = document.querySelectorAll(".stars47popular i");

                                // Loop through the "stars" NodeList
                                stars47popular.forEach((star, index1) => {
                                    // Add an event listener that runs a function when the "click" event is triggered
                                    // star.addEventListener("click", () => {
                                    // Loop through the "stars" NodeList Again
                                    stars47popular.forEach((star, index2) => {
                                        // Add the "active" class to the clicked star and any stars with a lower index
                                        // and remove the "active" class from any stars with a higher index

                                        -1 >= index2 ? star.classList.add("active") : star.classList.remove("active");
                                        document.getElementById("rating_47popular").innerHTML = 0;
                                        // console.log(index1);
                                    });
                                    // });
                                });
    ...
    <section class="locations section-pad border-bottom">
        ...
        <div class="location-content-v2">
            <div class="container">
                <div class="row">
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="height: 137.8px;">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=North and Middle Andaman&amp;search_listing=true"> North and Middle Andaman </a>
                            </h5>
                            <p> 1&nbsp; Ads posted </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="height: 137.8px;">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=Khagaria&amp;search_listing=true"> Khagaria </a>
                            </h5>
                            <p> 1&nbsp; Ads posted </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="height: 123.8px;">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=Rajkot&amp;search_listing=true"> Rajkot </a>
                            </h5>
                            <p> 1&nbsp; Ads posted </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="height: 123.8px;">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=Srinagar&amp;search_listing=true"> Srinagar </a>
                            </h5>
                            <p> 1&nbsp; Ads posted </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="height: 123.8px;">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=Ujjain&amp;search_listing=true"> Ujjain </a>
                            </h5>
                            <p> 1&nbsp; Ads posted </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="height: 123.8px;">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=Amrawati&amp;search_listing=true"> Amrawati </a>
                            </h5>
                            <p> 1&nbsp; Ads posted </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="height: 123.8px;">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=Bhandara&amp;search_listing=true"> Bhandara </a>
                            </h5>
                            <p> 1&nbsp; Ads posted </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="height: 123.8px;">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=Latur&amp;search_listing=true"> Latur </a>
                            </h5>
                            <p> 1&nbsp; Ads posted </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="height: 123.8px;">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=Nagpur&amp;search_listing=true"> Nagpur </a>
                            </h5>
                            <p> 4&nbsp; Ads posted </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="height: 123.8px;">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=Wardha&amp;search_listing=true"> Wardha </a>
                            </h5>
                            <p> 1&nbsp; Ads posted </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2 col-xs-6 match-height" style="">
                        <div class="location text-center border-bottom">
                            <h5>
                                <a href="./search_ads/index.php?category_id=&amp;listing_keyword=&amp;listing_city=Lucknow&amp;search_listing=true"> Lucknow </a>
                            </h5>
                            <p> 1&nbsp; Ads posted </p>
                        </div>
                    </div>
    ...
    <section class="partners-v3 section-gray-bg">
        <div class="container" style="overflow: hidden;">
            <div class="row">
                <div class="col-lg-12">
                    <div class="owl-carousel partner-carousel-v3 partner-carousel-v4 owl-theme owl-responsive-0 owl-loaded" data-car-length="6" data-items="6" data-loop="true" data-nav="false" data-autoplay="true" data-autoplay-timeout="2000" data-dots="true" data-auto-width="false" data-auto-height="true" data-right="false" data-responsive-small="2" data-autoplay-hover="true" data-responsive-medium="4" data-responsive-xlarge="6" data-margin="30">

                        <div class="owl-stage-outer">
                            <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 195.2px;">
                                <div class="owl-item active" style="width: 165.2px; margin-right: 30px;">
                                    <div class="item partner-img match-height" style="">
    ...
    <footer class="section-pad section-bg-black four-columns-footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-6 match-height" style="">
                    <div class="widget-box">
                        <div class="widget-title">
                            <img class="img-responsive" src="wp-content/uploads/2018/11/satya.png" alt=" ">
                        ...
                        </div><img class="img-responsive" src="wp-content/uploads/2018/11/75 india.png" alt=" ">
                    </div>
                </div>
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content">
                            <div class="media footer-pr-widget-v2">
                                <div class="media-left">
                                    <a class="media-img" href="#">
                                        <img class="media-object" src="wp-content/uploads/2018/11/new2.jpg" alt="Used BMW Car 2018 Model For Sale">
                                    </a>
                                </div>
                            ...
                            <div class="media footer-pr-widget-v2">
                                <div class="media-left">
                                    <a class="media-img" href="#">
                                        <img class="media-object" src="wp-content/uploads/2018/11/photo4.jpg" alt="Apple Mac Laptop For Sale In Cheapest Price">
                                    </a>
                                </div>
                                <div class="media-body">
                                    <span><i class="far fa-clock"></i>November 12, 2018</span>
                            ...
                            <div class="media footer-pr-widget-v2">
                                <div class="media-left">
                                    <a class="media-img" href="#">
                                        <img class="media-object" src="wp-content/uploads/2018/11/rural-craft-hub.jpg" alt="Blue Fabrics Loveseat Sofa for Sale">
                                    </a>
                                </div>
                                <div class="media-body">
                                    <span><i class="far fa-clock"></i>November 12, 2018</span>
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content">
                            <div class="media footer-pr-widget-v2">
                                <div class="media-left">
                                    <a class="media-img" href="#">
                                        <img class="media-object img-rounded" src="wp-content/uploads/2018/11/images1.jpg" alt="Donec volutpat lacinia ligula, in vestibulum ante">
                                    </a>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media footer-pr-widget-v2">
                                <div class="media-left">
                                    <a class="media-img" href="#">
                                        <img class="media-object img-rounded" src="wp-content/uploads/2018/11/images8.jpg" alt="Duis placerat felis vitae dui facilisis bibendum">
                                    </a>
                                </div>
                                <div class="media-body">
                                    <span><i class="far fa-clock"></i>June 1, 2017</span>
                            ...
                            <div class="media footer-pr-widget-v2">
                                <div class="media-left">
                                    <a class="media-img" href="#">
                                        <img class="media-object img-rounded" src="wp-content/uploads/2018/11/main.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit">
                                    </a>
                                </div>
                                <div class="media-body">
                                    <span><i class="far fa-clock"></i>June 1, 2017</span>
                ...
                <div class="col-lg-3 col-sm-6 match-height" style="">
                    <div class="widget-box">
                        <div class="widget-title">
                            <h4>Contact Info</h4>
                            <h3>Mahatma Gandhi Institute for Rural Industrialization</h3>
                        </div>
                        <div class="widget-content">
                            ...
                            <div class="contact-info">
                                ...
                                <div class="contact-info-box">
                                    <p>07152-253512/13[O], 253513[direct]</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <marquee class="sampleMarquee" direction="left" scrollamount="10" behavior="scroll">Mgiri Ruralhaat helpline no:+91
        715 225 3512 </marquee>
    <section class="footer-bottom" style="margin-bottom: 69.6px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-6">
                    <p>
                        All copyrights reserved © 2023 - Design &amp; Development by <a href="#">Royals WebTech Pvt. Ltd.</a> </p>
                </div>
                <div class="col-lg-6 col-sm-6">
    ...
    <div id="overlay_for_registration" class="custom_overlay " style="display:none;height: 100%;overflow: auto;position: fixed; padding-bottom:100px !important;">
                                ...
                                <div class=" my-4 ">
                                    ...
                                    <div class="social-login-v2 login-register">
                                        <form enctype="multipart/form-data" id="registration_form" class="text-center" method="POST">
                                            ...
                                            <div class="form-group">
                                                <div class="inner-addon left-addon">
                                                    <label class="" style="float:left" for="register_email">Email</label> <span style="color:red;" id="label_for_email_validation"></span> <input type="email" name="register_email" onchange="validation_for_email_username_phone()" onload="validation_for_email_username_phone()" id="register_email" class="form-control form-control-md sharp-edge" placeholder="Enter email address" data-error="Email required" required="">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div><!--Email Address-->
                                            ...
                                            <div class="form-group">
                                                <div class="inner-addon left-addon">
                                                    <label class="" style="float:left" for="register_phone">Phone no.</label> <span style="color:red;" id="label_for_phone_validation"></span><input type="tel" pattern="[0-9]{10}" name="register_phone" onchange="validation_for_email_username_phone()" onload="validation_for_email_username_phone()" id="register_phone" class="form-control form-control-md sharp-edge" placeholder="Enter 10 digit Phone no." data-error="Phone required" required="">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div><!--Phone no.-->
                                            <div class="form-group">
    ...
    <!-- back to top -->
    <a href="#" id="back-to-top" title="Back to top" class="social-icon social-icon-md show"><i class="fas fa-angle-double-up removeMargin"></i></a>
    <script type="text/javascript">
        (function() {
    ...
    <script type="text/javascript" id="classiera-helper-js-extra">
        ...
        var classiera = {
            ...
            "current_user": "0",
            "redirectURL": "https:\/\/demo.joinwebs.com\/classiera\/plum\/"
        };
        /* ]]> */
    </script>
    ...
    <script src="./user_panel/scripts/scripts/jquery-3.4.1.min.js"></script>
