...
<!-- Mirrored from ulisting.utouchdesign.com/ulisting_ltr/listings_single_page_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 11:25:56 GMT -->
<head>
                ...
                <ul>
                  ...
                  <li><a class="active" href="#">Listing Details</a>
                    <ul>
                      ...
                      <li><a class="active" href="listings_single_page_2.html">Single Listing Version 2</a></li>
      ...
      <div class="col-lg-8 col-md-8">
        <div id="titlebar" class="utf_listing_titlebar">
          <div class="utf_listing_titlebar_title">
           <h2>Burger House (MG Road) <span class="listing-tag">Food & Drinks</span></h2>
		...
		<div id="utf_listing_tags" class="utf_listing_section listing_tags_section">
          <h3 class="utf_listing_headline_part margin-top-40 margin-bottom-40">Listings Tags</h3>
        ...
        <div class="utf_listing_section">
          <h3 class="utf_listing_headline_part margin-top-50 margin-bottom-40">Menu Pricing</h3>
          <div class="show-more">
            <div class="utf_pricing_list_section">
              <h4>Fast Food and Drinks</h4>
              <ul>
                <li>
                  <h5>Aloo Cheese Burger <sub class="ppl-offer label-light-success">20% Off</sub></h5>
                  <p>It's new, hot and eligiius burger with cheese pasty.</p>
                  <span>$90</span> 
				</li>
                <li>
                  <h5>Double Veg. 'N' Spicy Burger <sub class="ppl-offer label-light-danger">Hot</sub></h5>
                  <p>It's new, hot and eligiius burger with cheese pasty.</p>
                  <span>$80</span> 
				</li>
				<li>
                  <h5>Cheese Hot Burger <sub class="ppl-offer label-light-success">20% Off</sub></h5>
                  <p>It's new, hot and eligiius burger with cheese pasty.</p>
                  <span>$90</span> 
				</li>
                <li>
                  <h5>Frozen Fruit Smoothie <sub class="ppl-offer label-light-success">20% Off</sub></h5>
                  <span>$12</span> 
				</li>
                <li>
                  <h5>Whole Oranges vs Orange Juice <sub class="ppl-offer label-light-success">15% Off</sub></h5>
                  <span>$8</span> 
				</li>
                <li>
      ...
      <div class="col-lg-4 col-md-4 margin-top-75 sidebar-search">
        ...
        <div class="utf_box_widget booking_widget_box">
          <h3><i class="fa fa-calendar"></i> Booking
			<div class="price">
				<span>55$<small>person</small></span>				
			</div>
		  </h3>
						...
						<div class="panel-dropdown-scrollable">
							...
							<div class="time-slot">
								...
								<label for="time-slot-4">
									...
									<span>Choose 2 Table Available</span>
								</label>
							</div>
