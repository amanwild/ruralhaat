...
<!-- Mirrored from ulisting.utouchdesign.com/ulisting_ltr/page_categorie_one.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 11:43:50 GMT -->
<head>
...
<div id="main_wrapper"> 
            ...
            <ul id="responsive">
              ...
              <li><a class="current" href="#">Pages</a>
                <ul>
				  ...
				  <li><a class="active" href="#">Categorie Type</a>
					<ul>
                      <li><a class="active" href="page_categorie_one.html">Categorie One</a></li>
  ...
  <div class="container">
	<div class="row">
      <div class="col-md-12">
        <h3 class="headline_part centered margin-top-75"> Browse Categories<span>Browse the most desirable categories</span></h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
