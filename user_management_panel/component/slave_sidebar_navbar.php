  ...
  <div class="utf_dashboard_navigation_inner_block">
    <ul>
      ...
      <li  id="user_dashboard_my_listing">
        <a href="javascript:void(0)"><i class="sl sl-icon-layers"></i> User Listings</a>
      ...
      <li id="user_dashboard_my_profile"><a href="dashboard_my_profile.php"><i class="sl sl-icon-user"></i> User Profile</a></li>
      <!-- <li id="user_dashboard_change_password"><a href="dashboard_change_password.php"><i class="sl sl-icon-key"></i> Change Password</a></li> -->
      <li id="" ><a href="../logout_slave/index.php"><i class="sl sl-icon-power"></i> Go Back</a></li>
    </ul>
  </div>
</div>