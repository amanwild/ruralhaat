          ...
          <div class="col-lg-12 col-md-12">
            <div class="utf_dashboard_list_box margin-top-0">
              ...
              <ul class="paginationTable">
                ...
                $select_query = "SELECT * FROM `listing` WHERE `listing_owner_id` = $user_id";
                if ($filter != "") {
                  $select_query = "SELECT * FROM `listing` WHERE `listing_owner_id` = $user_id AND `listing_status` LIKE '$filter'";
                }
                $select_result = mysqli_query($connect, $select_query);
                ...
                while ($row = mysqli_fetch_assoc($select_result)) {
                  ...
                  $select_rating_query = "SELECT * FROM `listing_rating` WHERE `listing_rating_by_user_id` = $user_id AND `listing_rating_on_product_id` = $listing_id";
