                ...
                <ul class="paginationTable">
                  ...
                  if ($select_interaction_num > 0) {
                    while ($row_for_interaction = mysqli_fetch_assoc($select_interaction_result)) {
                      ...
                      if ($sender_enquery_id !== '' && $sender_enquery_id !== '0') {
                  ...
                  ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Your Listing <b><?= $interaction_listing_title ?></b> is Active <i>New</i></h5>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Your Listing <b><?= $interaction_listing_title ?></b> is Pending <i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      <?php
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Your Listing <b><?= $interaction_listing_title ?></b> is Expired <i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      <?php
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Your Listing <b><?= $interaction_listing_title ?></b> is Approved <i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      <?php
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Your Listing <b><?= $interaction_listing_title ?></b> is Rejected <i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      <?php
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Your Listing <b><?= $interaction_listing_title ?></b> has been Shared on Facebook By <b><?= $interaction_user_first_name ?> <?= $interaction_user_last_name ?></b><i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      <?php
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Your Listing <b><?= $interaction_listing_title ?></b> has been Shared on Whatsapp By <b><?= $interaction_user_first_name ?> <?= $interaction_user_last_name ?></b><i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5><b><?= $interaction_user_first_name ?> <?= $interaction_user_last_name ?></b> has been click on your Email<i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5><b><?= $interaction_user_first_name ?> <?= $interaction_user_last_name ?></b> has been click on your Google link<i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5><b><?= $interaction_user_first_name ?> <?= $interaction_user_last_name ?></b> been click on your Youtube link<i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5><b><?= $interaction_user_first_name ?> <?= $interaction_user_last_name ?></b> been click on your phone no.<i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>You Have Unread Enquery from <b><?= $interaction_user_first_name ?> <?= $interaction_user_last_name ?></b><i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>You Have Unread Message from <b><?= $interaction_user_first_name ?> <?= $interaction_user_last_name ?></b><i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Your Listing <b><?= $interaction_listing_title ?></b> has been Reported for <?= $interaction_type?> By <b><?= $interaction_user_first_name ?> <?= $interaction_user_last_name ?></b><i>New</i></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                          </div>
                        </li>
                  ...
                  <?php
                    ...
                    <li class="tableItem dashboard_notifi_item ">
                      ...
                      <div class="text-center content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                        <h5><b>0 Notifiaction</b></h5>
                      </div>
                    </li>
