...
<!-- Mirrored from ulisting.utouchdesign.com/ulisting_ltr/listings_half_screen_map_list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 11:21:14 GMT -->
<head>
            ...
            <ul id="responsive">
              ...
              <li><a class="current" href="#">Listings</a>
                <ul>
				  ...
				  <li><a class="active" href="#">Half Listing Map</a>
                    <ul>
                      <li><a class="active" href="listings_half_screen_map_list.html">Listing Half List</a></li>
