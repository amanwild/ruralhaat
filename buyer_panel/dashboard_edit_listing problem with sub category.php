                      ...
                      <div class="row with-forms">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="intro-search-field utf-chosen-cat-single">
                            ...
                            // $select_category_sub_query = "SELECT * FROM sub_category where id = $listing_sub_category_id ";
                            try {
                            ...
                            if ($select_category_sub_num > 0) {
                              $sno = 0;
                              //Note : mysqli_fetch_assoc($result) it returns NULL when no data is persent to Select
                              while ($row_for_listing_category = mysqli_fetch_assoc($select_category_sub_result)) {
                                $sub_category_id = $row_for_listing_category['sub_category_id'];
                                $sub_category_name = $row_for_listing_category['sub_category_name'];
                                // echo $sub_category_name;
                              }
                            }
                            ?>
                            <select class=" default" style="margin-bottom:0px" name="sub-category" value="hello" title="hello" id="sub-category" data-selected-text-format="count">
                              ...
                              if ($select_category_sub_num > 0) {
                                ...
                                while ($row_for_listing_category = mysqli_fetch_assoc($select_category_sub_result)) {
                                  ...
                                  if ($listing_sub_category_id == $sub_category_id) {
                              ?>
                              <option name="sub-category" value="<?= $row_for_listing_category['sub_category_id'] ?>" select><?= $row_for_listing_category['sub_category_name']?></option>
                              <?php
                                  } else {
                                    ?>
                                    <option name="sub-category" value="<?= $row_for_listing_category['sub_category_id'] ?>"><?= $row_for_listing_category['sub_category_name']?></option>
                              <?php
                                  }
                                }
                              }
                      ...
                      <div class="row with-forms">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="fm-input pricing-price">
                            <input type="number" name="price" id="price" value="<?= $listing_price ?>" data-unit="$" />
                            <i class="data-unit">₨</i>
                          </div>
                        </div>
                        <div class="col-md-6">
                          ...
                          <div class="intro-search-field utf-chosen-cat-single">
                            <select class="selectpicker default" name="tags" id="tags" data-selected-text-format="count" title="<?= $listing_tag ?>">
                      ...
                      <div class="utf_submit_section">
                        <div class="row with-forms">
                          <div class="col-md-6">
                            ...
                            <div class="intro-search-field utf-chosen-cat-single">
                              <select class="selectpicker default" name="country" id="country" data-selected-text-format="count" title="<?= $row['name']  ?>">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="intro-search-field utf-chosen-cat-single">
                              <select class=" default" name="state" style="margin-bottom:0px" id="state" data-selected-text-format="count" title="<?= $row['listing_state']  ?>">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="intro-search-field utf-chosen-cat-single">
                              <select class=" default" style="margin-bottom:0px" name="city" id="city" data-selected-text-format="count" title="<?= $row['city_name'] ?>">
