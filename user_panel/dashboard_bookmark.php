...
<!-- Mirrored from ulisting.utouchdesign.com/ulisting_ltr/dashboard_bookmark.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 11:41:57 GMT -->
<head>
...
<?php include "./component/header.php" ?>
  ...
  <?php include "./component/user_sidebar_navbar.php" ?>
    ...
    <script>
      var d = document.getElementById("user_dashboard_bookmark");
      d.className += "active";
    </script>
          ...
          <div class="utf_dashboard_list_box margin-top-0">
            ...
            <ul>
              <li>
                ...
                <div class="buttons-to-right"> <a href="#" class="button gray"><i class="sl sl-icon-close"></i> Delete</a> </div>
              </li>
              <li>
                <div class="utf_list_box_listing_item">
                  <div class="utf_list_box_listing_item-img">
					<a href="#"><img src="images/utf_listing_item-02.jpg" alt=""></a>
					<span class="like-icon"></span> 
				  </div>
                  <div class="utf_list_box_listing_item_content">
                    <div class="inner">
              ...
              <li>
                <div class="utf_list_box_listing_item">
                  <div class="utf_list_box_listing_item-img">
					<a href="#"><img src="images/utf_listing_item-03.jpg" alt=""></a>
					<span class="like-icon"></span> 
				  </div>
                  <div class="utf_list_box_listing_item_content">
                    <div class="inner">
			  ...
			  <li>
                <div class="utf_list_box_listing_item">
                  <div class="utf_list_box_listing_item-img">
					<a href="#"><img src="images/utf_listing_item-04.jpg" alt=""></a>
					<span class="like-icon"></span> 
				  </div>
                  <div class="utf_list_box_listing_item_content">
                    <div class="inner">
