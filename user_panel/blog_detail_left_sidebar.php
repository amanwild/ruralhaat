...
<!-- Mirrored from ulisting.utouchdesign.com/ulisting_ltr/blog_detail_left_sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 11:43:50 GMT -->
<head>
...
<div id="main_wrapper"> 
            ...
            <ul id="responsive">
              ...
              <li><a class="current" href="#">Blog</a>
				  <ul>
					...
					<li><a class="active" href="blog_detail_left_sidebar.php">Blog Detail Leftside</a></li>
  ...
  <div id="titlebar" class="gradient">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2>Blog Detail Left Sidebar</h2>
          <nav id="breadcrumbs">
            <ul>
              <li><a href="index_1.php">Home</a></li>
              <li>Blog Detail Left Sidebar</li>
            </ul>
          </nav>
        </div>
      </div>
      ...
      <div class="row"> 
		...
		<div class="col-lg-8 col-md-8"> 
          <div class="utf_blog_post utf_single_post"> 
            <img class="utf_post_img" src="images/blog-post-01.jpg" alt=""> 
            ...
            <ul>
              <li>
                ...
                <div class="utf_comment_content">
                  ...
                  <div class="utf_by_comment">Robert Mil<span class="date"><i class="fa fa-clock-o"></i> Feb 02, 2022 / 12:52 pm</span> <a href="#" class="reply">Reply <i class="fa fa-reply"></i></a> </div>
                    ...
                    <ul>
                      <li>
                        ...
                        <div class="utf_comment_content">
                          <div class="utf_arrow_comment"></div>
						  <div class="utf_star_rating_section" data-rating="4.5"></div>
                          <div class="utf_by_comment">John Doe<span class="date"><i class="fa fa-clock-o"></i> Feb 02, 2022 / 12:52 pm</span> <a href="#" class="reply">Reply <i class="fa fa-reply"></i></a> </div>
