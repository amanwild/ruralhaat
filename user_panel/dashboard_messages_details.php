...
<!-- Mirrored from ulisting.utouchdesign.com/ulisting_ltr/dashboard_messages_details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 11:49:43 GMT -->
<head>
<meta name="author" content="">
<meta name="description" content="">
<meta http-equiv="Content-Type" content="text/html;charset=UTF-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Massage Details</title>
      ...
      <div class="row"> 
        <div class="col-lg-12 col-md-12">
          <div class="utf_dashboard_list_box margin-top-0">
            <h4 class="gray"><i class="sl sl-icon-user"></i> John Doe</h4>            
			<div class="utf_messages_block_inner"> 
              <div class="utf_user_messages_block">
                <ul>
                  ...
                  <li> 
					<a href="dashboard_messages_details.html">
						<div class="utf_message_user"><img src="images/user_avatar_05.jpg" alt="user_avatar" /></div>
						<div class="utf_message_headline_item">
						  <div class="utf_message_headline_text">
							<h5>John Doe</h5>
							<span><i class="fa fa-clock-o"></i> Jan 05, 2022 - 8:52 am</span>  
                  ...
                  <li> 
					<a href="dashboard_messages_details.html">
						<div class="utf_message_user"><img src="images/user_avatar_06.jpg" alt="user_avatar" /></div>
						<div class="utf_message_headline_item">
						  <div class="utf_message_headline_text">
							<h5>John Doe</h5>
							<span><i class="fa fa-clock-o"></i> Jan 05, 2022 - 8:52 am</span>  
                  ...
                  <li> 
					<a href="dashboard_messages_details.html">
						<div class="utf_message_user"><img src="images/user_avatar_07.jpg" alt="user_avatar" /></div>
						<div class="utf_message_headline_item">
						  <div class="utf_message_headline_text">
							<h5>John Doe</h5>
							<span><i class="fa fa-clock-o"></i> Jan 05, 2022 - 8:52 am</span>  
                  ...
                  <li> 
					<a href="dashboard_messages_details.html">
						<div class="utf_message_user"><img src="images/user_avatar_08.jpg" alt="user_avatar" /></div>
						<div class="utf_message_headline_item">
						  <div class="utf_message_headline_text">
							<h5>John Doe</h5>
							<span><i class="fa fa-clock-o"></i> Jan 05, 2022 - 8:52 am</span>  
                  ...
                  <li> 
					<a href="dashboard_messages_details.html">
						<div class="utf_message_user"><img src="images/user_avatar_09.jpg" alt="user_avatar" /></div>
						<div class="utf_message_headline_item">
						  <div class="utf_message_headline_text">
							<h5>John Doe</h5>
							<span><i class="fa fa-clock-o"></i> Jan 05, 2022 - 8:52 am</span>  
...
<!-- Mirrored from ulisting.utouchdesign.com/ulisting_ltr/dashboard_messages_details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 11:49:59 GMT -->
</html>