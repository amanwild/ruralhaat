                                                ...
                                                <div class="edit-profile-photo" style=" display: block; margin-bottom: 35px; text-align: center;"> <img id="profile_dp" style="border-radius: 50%; max-width: 200px; width: 100%; border: 10px solid rgba(0, 0, 0, 0.08);" src="../wp-content/uploads/data/<?= $category_image ?>" alt="">
                                                    <div class="change-photo-btn" style="font-weight: 600; padding: 5px; color: #333; background-color: #fff; border-radius: 50px; display: inline-block; position: relative; font-size: 13px; width: auto; transition: 0.3s; cursor: pointer; line-height: 20px; position: absolute; bottom: 35px; left: 0; right: 0; width: 140px; margin: 0 auto; ">
                                                        <div class="photoUpload"> <span><i class="fa fa-upload"></i> Upload Photo</span>
                                                            <input type="file" id="category_image" name="category_image" onchange="showimg();" style=" position: absolute; top: 0; right: 0; margin: 0; padding: 0; cursor: pointer; opacity: 0;" class="upload">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
