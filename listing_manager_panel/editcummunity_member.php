...
if($select_result){
                                        ...
                                        <div class="form-row mb-2">
                                            ...
                                            <div class="col-md-6 mx-auto mb-3">
                                                ...
                                                <div class="edit-profile-photo" style=" display: block; margin-bottom: 35px; text-align: center;">     <img id="profile_dp" style="border-radius: 50%; max-width: 200px; width: 100%; border: 10px solid rgba(0, 0, 0, 0.08);" src="../wp-content/uploads/data/<?= $member_image ?>" alt="">
                                                  <div class="change-photo-btn" style="font-weight: 600; padding: 5px; color: #333; background-color: #fff; border-radius: 50px; display: inline-block; position: relative; font-size: 13px; width: auto; transition: 0.3s; cursor: pointer; line-height: 20px; position: absolute; bottom: 35px; left: 0; right: 0; width: 140px; margin: 0 auto; ">
                                            ...
                                            </div> <div class="col-md-6 mx-auto mb-3">
  ...
  if (($_SERVER["REQUEST_METHOD"] == "POST") && (isset($_POST['updateMember']) && isset($_POST['member_name']))) {
    if ($update_member_result) {
        ...
        echo "<script>alert('Member Successfully Updated !! ') </script>" . "<br>";
    } else {
        echo "<script>alert('Member is not  Updated !! ') </script>" . "<br>";
    }}?>
