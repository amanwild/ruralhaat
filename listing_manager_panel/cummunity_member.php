  ...
  <div class="container">
    ...
    try {
      ...
      if ($connect) {
        ...
        if ($select_result) {
          $member_num = mysqli_num_rows($select_result);
        }
      }
    } catch (Exception $e) {
      $mess = $e->getMessage();
      ...
      <div class="allContent-section container   pt-0" style="margin-bottom: 20px;">
        ...
        <div class=" my-1">
          <div id="showLocatonContent" class="d-flex text-center mt-3 ">
            <h1 class=" my-auto mr-auto d-inline"> All Cummunity Members</h1>
              ...
              <tbody>
                ...
                ?>
                    ...
                    <tr>
                      ...
                      <td><img src="../wp-content/uploads/data/<?= $row['member_image'] ?>" class="rounded-circle img-fluid" style="object-fit:cover;max-width: 32px;height: auto;" class="mr-3 p-1" alt="." /></td>
                      <td class="text-center">
                         
                      <button type="submit" onclick="window.location.href='./editcummunity_member.php?member_id=<?=  $row['member_id'] ?>'" class="d-inlineedit table_edit_btn "style="border:none;background-color:transparent;font-size:inherit;" >📝</button>

                  <form onsubmit="return confirm('Are you sure? you want to Delete Category!');" method="POST" style="display:inline-block" action="<?= $_SERVER["REQUEST_URI"]; ?>">
                        <input type="hidden" id="member_id" name="member_id" value="<?=  $row['member_id'] ?>" />
                        <input type="hidden" id="delete_member" name="delete_member" value="true" />
          ...
          <div class="" style="display:flex;text-align:center; ">
            <button type="button" style="padding:10px !important;" class="table_btn btn btn-success " onclick="window.location.href='./addcummunity_member.php'">Add Cummunity Member
            </button>
          </div>
