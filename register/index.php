...
<!-- Mirrored from demo.joinwebs.com/classiera/plum/register/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Apr 2023 08:25:40 GMT -->
<!-- Added by HTTrack -->
...
*/
  ...
  <link rel="alternate" type="application/json" href="../wp-json/wp/v2/pages/57.json" />
  ...
  <link rel="alternate" type="application/json+oembed"
    href="../wp-json/oembed/1.0/embedf9e7.json?url=https%3A%2F%2Fdemo.joinwebs.com%2Fclassiera%2Fplum%2Fregister%2F" />
  <link rel="alternate" type="text/xml+oembed"
    href="../wp-json/oembed/1.0/embed1f35?url=https%3A%2F%2Fdemo.joinwebs.com%2Fclassiera%2Fplum%2Fregister%2F&amp;format=xml" />
...
<body data-rsssl=1
  class="page-template page-template-template-register page-template-template-register-php page page-id-57 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
        ...
        <div class="menu-main-menu-container">
          <ul id="menu-main-menu" class="nav navmenu-nav">
            <li id="menu-item-190"
              ...
              <a title="Home" href="../index.html" data-toggle="dropdown" data-hover="dropdown" data-animations="fadeIn"
            ...
            <li id="menu-item-191" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-191"><a
                title="Blog" href="#">Blog</a></li>
            <li id="menu-item-193"
              class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-33 current_page_item menu-item-193 active">
              <a title="Contact" href="../contact/index.php">Contact</a></li>
          </ul>
        </div>
        ...
        <nav class="navbar navbar-default ">
          ...
          <div class="collapse navbar-collapse visible-lg" id="navbarCollapse">
            ...
            <ul id="menu-main-menu-1" class="nav navbar-nav navbar-right nav-margin-top flip nav-ltr">
              ...
              <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-192"><a title="Sucess Stories"
                  href="#">Sucess Stories </a></li>
              
              <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-191"><a title="Blog"
                  href="#">Blog</a></li>
              <li
                class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-33 current_page_item menu-item-193 active">
                <a title="Contact" href="../contact/index.php">Contact</a></li>
          ...
          <div class="col-lg-10 col-md-11 col-sm-12 center-block">
            ...
            <div class="row">
              <div class="col-lg-12" id="register_form">
                ...
                <form action="./add_new_user.php" onsubmit="alert('success');" method="POST">
                  <div class="form-group">
                    <div class="inner-addon left-addon">
                      <i class="left-addon form-icon fas fa-user"></i>
                      <input type="text" name="username" id="username" class="form-control form-control-md sharp-edge"
                        placeholder="Enter username" data-error="Username required" required>
                  ...
                  <div class="form-group">
                    <div class="inner-addon left-addon">
                      ...
                      <input type="email" name="email" id="email" class="form-control form-control-md sharp-edge"
                        placeholder="Enter email address" data-error="Email required" required>
                      <div class="help-block with-errors"></div>
                    </div>
                  </div><!--Email Address-->
                  <div class="form-group">
                    <div class="inner-addon left-addon">
                      ...
                      <input type="tel"  pattern="[0-9]{10}" name="phone" id="phone" class="form-control form-control-md sharp-edge"
                        placeholder="Enter Phone no." data-error="Phone required" required>
                  ...
                  <div class="form-group">
                    <div class="inner-addon left-addon">
                      ...
                      <input type="password" name="password" id="password" minlength="5"  data-minlength="5"
                        class="form-control form-control-md sharp-edge" placeholder="Enter password" id="registerPass"
                        data-error="Password required" required>
                      <div class="help-block"><b>Minimum of 5 characters.</b></div>
                    </div>
                  </div><!--Password-->
                  <div class="form-group">
                    <div class="inner-addon left-addon">
                      <i class="left-addon form-icon fas fa-lock"></i>
                      <input type="password" name="c_password" id="c_password"   minlength="5"  data-minlength="5" class="form-control form-control-md sharp-edge"
                        placeholder="Re-enter password" data-match="#registerPass"
                        data-match-error="Whoops, these don&rsquo;t match" data-error="re-enter password" required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="form-group">
                    <div class="checkbox">
                      <input type="checkbox" value="forever" name="remember" id="agree"
                        data-error="You must agree to our Terms and Conditions" required>
                  ...
                  <div class="form-group">
                    ...
                    <button class="btn btn-primary sharp btn-md btn-style-one" id="edit-submit" name="op_classiera"
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-sm-6">
          <p>
            All copyrights reserved © 2015 - Design & Development by <a href="http://joinwebs.com/">Royals Webtech Pvt. Ltd.</a> </p>
        </div>
        <div class="col-lg-6 col-sm-6">
...
/* ]]> */
  ...
  <script type='text/javascript' id='classiera-helper-js-extra'>
    /* <![CDATA[ */
    var classiera = { "ajaxurl": "https:\/\/demo.joinwebs.com\/classiera\/plum\/wp-admin\/admin-ajax.php", "home_url": "https:\/\/demo.joinwebs.com\/classiera\/plum", "current_user": "0", "redirectURL": "https:\/\/demo.joinwebs.com\/classiera\/plum\/register\/" };
/* ]]> */
  </script>
...
<!-- Mirrored from demo.joinwebs.com/classiera/plum/register/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Apr 2023 08:25:49 GMT -->
