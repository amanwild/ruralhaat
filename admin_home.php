...
<body data-rsssl=1 class="home page-template page-template-template-landing page-template-template-landing-php page page-id-43 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
	...
	<section class="classiera-static-slider">
		...
		<section class="search-section search-section-v6">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<form data-toggle="validator" role="search" class="search-form search-form-v2 form-inline" action="#" method="get">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="classiera-category-content">
						<a href="#" class="classiera-category-new-v2-box" data-color="#683eff">
	...
	<?php include "./home_cummunity_member.php" ?>
