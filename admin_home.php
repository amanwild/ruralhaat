	...
	<section class="classiera-static-slider">
		...
		<section class="search-section search-section-v6">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<form enctype="multipart/form-data"  data-toggle="validator" enctype="multipart/form-data" role="search" class="search-form search-form-v2 form-inline" action="#" method="get">
