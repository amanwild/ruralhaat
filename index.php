				...
				while ($row = mysqli_fetch_assoc($exist_result)) {
					...
					if (password_verify($login_password, $row['user_password'])) {
						...
						if ($row['user_type'] == 'admin') {
							echo "<script> window.location.replace('../author/admin_panel/index.php');</script>";
						}

						if ($row['user_type'] == 'user') {
							echo "<script> window.location.replace('../author/user_panel/dashboard.php');</script>";
						}
						if ($_SESSION['user_type'] == "registration_manager") {
							// echo "admin";
							echo "<script> window.location.replace('../author/registration_manager_panel/index.php');</script>";
						}
						if ($_SESSION['user_type'] == "listing_manager") {
							// echo "admin";
							echo "<script> window.location.replace('../author/listing_manager_panel/product_details.php');</script>";
						}
						if ($_SESSION['user_type'] == "inspector") {
							// echo "admin";
							echo "<script> window.location.replace('../author/inspector_panel/index.php');</script>";
						}
						if ($_SESSION['user_type'] == "data_analyst") {
							// echo "admin";
							echo "<script> window.location.replace('../author/data_analyst_panel/index.php');</script>";
						}
						if ($_SESSION['user_type'] == "user_manager") {
							// echo "admin";
							echo "<script> window.location.replace('../author/user_manager_panel/user_management.php');</script>";
						}
					}
				}
			} else {
...
<body data-rsssl=1 class="home page-template page-template-template-landing page-template-template-landing-php page page-id-43 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
...
include "db.php";
	...
	<img class="img-responsive" src="wp-content/uploads/2018/11/india.jpg" alt="Classiera Classifieds Ads WordPress Theme">


	<div class="image-container">
		<img class="img-responsive" src="wp-content/uploads/2018/11/mgiri.png" alt="Classiera Classifieds Ads WordPress Theme">
	</div>
	<br>
	...
	$select_query = "SELECT * FROM `category`"; //NOTE: here (`) is not equal to (')
	try {
		$select_result = 0;
		if ($connect) {
	...
	<section class="section-pad classiera-category-new-v2">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="classiera-category-content"><?php

															if ($num > 0 || $update_result || $insert_result) {
																$sno = 0;
																//Note : mysqli_fetch_assoc($result) it returns NULL when no data is persent to Select
																while ($row = mysqli_fetch_assoc($select_result)) {
																	include "./home_category.php";
																}
															}
															?>
					...
					<div style="overflow: hidden; padding-top:10px;">
						<div style="margin-bottom: 40px;">
							<div id="owl-demo" class="owl-carousel premium-carousel-v5" data-car-length="4" data-items="4" data-loop="true" data-nav="false" data-autoplay="true" data-autoplay-timeout="3000" data-dots="false" data-auto-width="false" data-auto-height="true" data-right="false" data-responsive-small="1" data-autoplay-hover="true" data-responsive-medium="2" data-responsive-large="4" data-responsive-xlarge="4" data-margin="30">
								...
								$select_query = "SELECT * FROM `cummunity_member`"; //NOTE: here (`) is not equal to (')
								try {
									$select_result = 0;
									if ($connect) {
										$select_result = mysqli_query($connect, $select_query);
										if ($select_result) {
											$cummunity_member_num = mysqli_num_rows($select_result);
										}
									}
								} catch (Exception $e) {
									$mess = $e->getMessage();
								...
								if ($cummunity_member_num > 0) {
									$sno = 0;
									//Note : mysqli_fetch_assoc($result) it returns NULL when no data is persent to Select
									while ($row = mysqli_fetch_assoc($select_result)) {
										include "./home_cummunity_member.php";
									}
								}
								?>
				...
				<div class="col-lg-3 col-sm-6 match-height">
					<div class="widget-box">
						<div class="widget-title">
							<img class="img-responsive" src="wp-content/uploads/2018/11/satya.png" alt="Classiera Classifieds Ads WordPress Theme">
						...
						</div><img class="img-responsive" src="wp-content/uploads/2018/11/75 india.png" alt="Classiera Classifieds Ads WordPress Theme">
					</div>
				</div>
