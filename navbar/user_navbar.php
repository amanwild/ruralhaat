    ...
    <nav id="myNavmenu" class="navmenu navmenu-default offcanvas offcanvas-light navmenu-fixed-left"
        ...
        <div class="menu-main-menu-container">
          <ul id="menu-main-menu" class="nav navmenu-nav">
            ...
            <li id="menu-item-190"
              class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children menu-item-190 dropdown">
              <a title="Home" href="../user_panel/dashboard.php" data-toggle="dropdown" data-hover="dropdown" data-animations="fadeIn"
                class="dropdown-toggle" aria-haspopup="true">User_panel <span class="caret"></span></a>
            </li>
            <li id="menu-item-190"
              class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children menu-item-190 dropdown">
              <a title="Home" href="./product_details.php" data-toggle="dropdown" data-hover="dropdown" data-animations="fadeIn"
                class="dropdown-toggle" aria-haspopup="true">Products <span class="caret"></span></a>
            </li>
            <li id="menu-item-190"
              class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children menu-item-190 dropdown">
              <a title="Home" href="./category.php" data-toggle="dropdown" data-hover="dropdown" data-animations="fadeIn"
      ...
      <nav class="navbar navbar-default ">
        ...
        <div class="collapse navbar-collapse visible-lg" id="navbarCollapse">
          ...
          <ul id="menu-main-menu-1" class="nav navbar-nav navbar-right nav-margin-top flip nav-ltr">
            ...
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children menu-item-190 dropdown">
              <a title="Home" href="../user_panel/dashboard.php" data-toggle="dropdown" data-hover="dropdown" data-animations="fadeIn" class="dropdown-toggle" aria-haspopup="true">User Panel
              </a>
            </li>
            <!-- <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children menu-item-190 dropdown">
              <a title="Home" href="../contact/index.php" data-toggle="dropdown" data-hover="dropdown" data-animations="fadeIn" class="dropdown-toggle" aria-haspopup="true">Contact
              </a>
            </li> -->
