...
<script>
  ...
  function approve_ac_for_conversion(id) {

    show_preloader();
    $.ajax({
      url: "./approve_ac_for_conversion.php",
      type: "POST",
      data: {
        type: "approve",
        id: id,
      ...
      success: function(result) {
        console.log(result);
        console.log("approve " + id);
        document.getElementById("status_" + id).innerHTML = `<span style="background-color:green;color:white;padding:5px;font-weight:700;border-radius:5px;">Seller</span>`;
        hide_preloader();
      }
    });
  }

  function approve_ac_with_checkbox_for_conversion() {
    hide_checkbox();
    var total_check_boxes = $("input:checkbox[name='row-check']").length;
    var total_checked_boxes = $("input:checkbox[name='row-check']:checked").length;
    show_preloader();
    ...
    console.log(array_of_checked_id);
    console.log("\n");
    array_of_checked_id.forEach(to_Update_Color_green_for_conversion);
  ...
  function reject_ac_with_checkbox_for_conversion() {
    hide_checkbox();
    show_preloader();
    var total_check_boxes = $("input:checkbox[name='row-check']").length;
    var total_checked_boxes = $("input:checkbox[name='row-check']:checked").length;
    ...
    array_of_checked_id.forEach(to_Update_Color_red_for_conversion);
    $.ajax({
      url: "./reject_ac_for_conversion.php",
      type: "POST",
      data: {
        type: "reject",
        array_of_checked_id: array_of_checked_id,
  ...
  function to_Update_Color_red_for_conversion(id) {
    // alert("red");
    document.getElementById("status_" + id).innerHTML = `<span style="background-color:red;color:white;padding:5px;font-weight:700;border-radius:5px;">Buyer</span>`;
  }

  function to_Update_Color_green_for_conversion(id) {
    // alert("green");
    document.getElementById("status_" + id).innerHTML = `<span style="background-color:green;color:white;padding:5px;font-weight:700;border-radius:5px;">Seller</span>`;
  }
  ...
  function reject_ac_for_conversion(id) {
    show_preloader(); 
    $.ajax({
      url: "./reject_ac_for_conversion.php",
      type: "POST",
      ...
      success: function(result) {
        ...
        console.log("reject " + id);
        hide_preloader();
        to_Update_Color_red_for_conversion(id)
      }
    });
  }
