...
include "../db.php";
    ...
    if (($_SERVER["REQUEST_METHOD"] == "POST") && (isset($_POST['addCategory']) && isset($_POST['category_name']))) {
        ...
        $add_product_query = "INSERT INTO `category` (`category_id`, `category_name`, `category_keyword`, `category_image`, `category_color`) VALUES (NULL, '$category_name', '', '$category_image', '$category_color')";
