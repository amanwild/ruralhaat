                    ...
                    <div class="card-body " style="margin-top:20px !important; border-radius:8px ;box-shadow: 1px 1px 20px #000000;">
                        <div class="jumbotron py-1" style="border-radius:8px;background-color: gold linear-gradient(to bottom, lightyellow, gold);">
                            <div class=" my-4 ">
                                ...
                                <hr class="my-3">
                                <form class="needs-validation " action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                                    <div class="container p-2 " style="border-radius:8px;">
                                        ...
                                        <div class="col-md-6 mx-auto mb-3">
                                                ...
                                                <div class="edit-profile-photo" style=" display: block; margin-bottom: 85px; text-align: center;">     <img id="profile_dp" style="border-radius: 50%; max-width: 200px; width: 100%; border: 10px solid rgba(0, 0, 0, 0.08);" src="../wp-content/uploads/data/<?= $member_image ?>" alt="">
                                                  <div class="change-photo-btn" style="font-weight: 600; padding: 5px; color: #333; background-color: #fff; border-radius: 50px; display: inline-block; position: relative; font-size: 13px; width: auto; transition: 0.3s; cursor: pointer; line-height: 20px; position: absolute; bottom: -50px; left: 0; right: 0; width: 140px; margin: 0 auto; ">
                                                    <div class="photoUpload"> <span><i class="fa fa-upload"></i> Upload Photo</span>
                                                      <input type="file" id="member_image" name="member_image" onchange="showimg();" style=" position: absolute; top: 0; right: 0; margin: 0; padding: 0; cursor: pointer; opacity: 0;" class="upload">
                                                    </div>
                                                  </div>
                                                </div>
                                            </div>
...
<!--                                             
    ...
    <script>
      function showimg() { var x = (document.getElementById("member_image").value).slice(12, 100); console.log(x); document.getElementById("profile_dp").src = "../wp-content/uploads/data/" + x; }
