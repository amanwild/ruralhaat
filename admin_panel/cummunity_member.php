<?php include "../validation_of_admin.php";include "../service/unlink_image.php"; ?>
...
<body data-rsssl=1 class="page-template page-template-template-login page-template-template-login-php page page-id-49 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
  ...
  <div class="container">
    ...
    if (isset($_POST["delete_member"]) && ($_SERVER["REQUEST_METHOD"] == "POST")) {
      ...
      unlink_img('member_image' ,'cummunity_member','member_id', $member_id, $connect);
    ...
    $select_query = "SELECT * FROM `cummunity_member` ORDER BY `cummunity_member`.`member_id` DESC"; //NOTE: here (`) is not equal to (')
    try {
      $select_result = 0;
      if ($connect) {
