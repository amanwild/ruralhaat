...
<body data-rsssl=1 class="page-template page-template-template-login page-template-template-login-php page page-id-49 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
  ...
  <div class="container">
    ...
    $select_query = "SELECT * FROM `user_interaction`"; //NOTE: here (`) is not equal to (')
    try {
      ...
      <div class="allContent-section container   pt-0" style="margin-bottom: 20px;">
        ...
        <div class=" my-1">
          <div id="showLocatonContent" class="d-flex text-center mt-3 ">
            <h1 class=" my-auto mr-auto d-inline">  User Tracking</h1>
                        ...
                        if ($select_interaction_by_user_id_query != '') {
                          ...
                          if ($select_interaction_by_user_id_num > 0) {
                            while ($row_for_interaction_by_user_id = mysqli_fetch_assoc($select_interaction_by_user_id_result)) {
                              ...
                              $interaction_by_user_image = $row_for_interaction_by_user_id['user_image'];
                              $interaction_by_user_username = $row_for_interaction_by_user_id['user_username'];
                              $interaction_by_user_email = $row_for_interaction_by_user_id['user_email'];
                              $interaction_by_user_phone = $row_for_interaction_by_user_id['user_phone'];
                            }
                          }
                      ...
                      if ($select_interaction_sender_enquery_id_query != '') {
                        ...
                        if ($select_interaction_sender_enquery_id_num > 0) {
                          while ($row_for_interaction_sender_enquery_id = mysqli_fetch_assoc($select_interaction_sender_enquery_id_result)) {
                            ...
                            $interaction_by_user_phone = $row_for_interaction_sender_enquery_id['enquery_phone'];
                            $interaction_by_user_email = $row_for_interaction_sender_enquery_id['enquery_email'];
                            $interaction_by_user_first_name = $row_for_interaction_sender_enquery_id['enquery_first_name'];
                            $interaction_by_user_last_name = $row_for_interaction_sender_enquery_id['enquery_last_name'];
                            $interaction_by_user_username = '';
                            $interaction_by_user_image = 'dashboard-avatar.jpg';
                          }
                        }
                        // echo "interaction_user_type " . $interaction_user_type . "<br>";
                        // echo "interaction_user_first_name " . $interaction_user_first_name . "<br>";
                      ...
                      if ($on_listing_id != '' && $on_listing_id != '0') {
                        ...
                        if ($select_interaction_on_listing_id_num > 0) {
                          while ($row_for_interaction_on_listing_id = mysqli_fetch_assoc($select_interaction_on_listing_id_result)) {
                            ...
                            $interaction_on_listing_image = $row_for_interaction_on_listing_id['listing_image'];
                            $interaction_on_listing_price = $row_for_interaction_on_listing_id['listing_price'];
                            $interaction_on_listing_city_name = $row_for_interaction_on_listing_id['listing_city_name'];
                            $interaction_on_listing_state_name = $row_for_interaction_on_listing_id['listing_state_name'];
                            $interaction_on_listing_title = $row_for_interaction_on_listing_id['listing_title'];
                          }
                        }
