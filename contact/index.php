...
*/
  ...
  <link rel="alternate" type="application/json+oembed"
    href="../wp-json/oembed/1.0/embedf71c.json?url=https%3A%2F%2Fdemo.joinwebs.com%2Fclassiera%2Fplum%2Fcontact%2F" />
  <link rel="alternate" type="text/xml+oembed"
    href="../wp-json/oembed/1.0/embedbc8f?url=https%3A%2F%2Fdemo.joinwebs.com%2Fclassiera%2Fplum%2Fcontact%2F&amp;format=xml" />
...
<body data-rsssl=1
  class="page-template page-template-template-contact page-template-template-contact-php page page-id-33 theme-classiera woocommerce-no-js single-author elementor-default elementor-kit-1989">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <form name="contactForm" action="#" id="contact-form"
              ...
              <div class="form-inline row">
                <div class="form-group col-sm-6">
                  ...
                  <div class="inner-addon left-addon">
                    ...
                    <input id="name" type="text" name="contactName" class="form-control form-control-md"
                      placeholder="Enter your full name" data-error="Name Required" required>
                ...
                <div class="form-group col-sm-6">
                  ...
                  <div class="inner-addon left-addon">
                    ...
                    <input id="email" type="text" name="email" class="form-control form-control-md"
                      placeholder="Enter your email" data-error="Email required" required>
                    <div class="help-block with-errors"></div>
                  </div>
                </div><!--Email-->
                <div class="form-group col-sm-6">
                  <label class="text-capitalize" for="phone">Phone : <span class="text-danger">*</span> </label>
                  <div class="inner-addon left-addon">
                    <i class="left-addon form-icon fas fa-phone"></i>
                    <input id="phone" type="text" name="phone" class="form-control form-control-md"
                ...
                <div class="form-group col-sm-6">
                  ...
                  <div class="inner-addon left-addon">
                    ...
                    <input id="subject" name="subject" type="text" class="form-control form-control-md"
                      placeholder="Enter Subject" data-error="Subject Requried" required>
                    <div class="help-block with-errors"></div>
                  </div>
                </div><!--Subject Div-->
                <div class="form-group col-sm-12">
                  ...
                  <div class="inner-addon">
                    <textarea data-error="Please type message" name="comments" id="text"
                ...
                <div class="form-group col-sm-6">
                  ...
                  <div class="inner-addon left-addon">
                    ...
                    <input id="humanTest" type="text" name="humanTest" class="form-control form-control-md"
                      placeholder="Your Answer" data-error="Security Answer Required" required>
                    <div class="help-block with-errors"></div>
            ...
            <div class="form-group">
              ...
              <button class="btn btn-primary sharp btn-md btn-style-one" type="submit" value="submit"
                name="submitted">Send Message</button>
            </div>
          </form>
        </div><!--col-lg-8-->
        <!-- <div class="col-lg-4">
          ...
          <ul class="contact-us-info list-unstyled fa-ul">
            <li><i class="fa-li fas fa-map-marker-alt"></i>
              Mangalwari Complex, Sadar Nagpur Maharashtra </li>
...
/* ]]> */
  ...
  <script type='text/javascript' id='classiera-helper-js-extra'>
    /* <![CDATA[ */
    var classiera = { "ajaxurl": "https:\/\/demo.joinwebs.com\/classiera\/plum\/wp-admin\/admin-ajax.php", "home_url": "https:\/\/demo.joinwebs.com\/classiera\/plum", "current_user": "0", "redirectURL": "https:\/\/demo.joinwebs.com\/classiera\/plum\/contact\/" };
/* ]]> */
  </script>
